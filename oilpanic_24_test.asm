...
.var VIC_SCREEN_MEMORY		= $5c00
.var Sprite_Pointer			= VIC_SCREEN_MEMORY+$3f8	// screen is at $5c00, set sprite pointer --> VIC BANK + $800 (32 x 64)
...
.const screen_ptr			= $fb
.const data_ptr				= $fd
// .const COLLECTOR_SPEED_A	= $2c
// .const COLLECTOR_EDGE_WAIT_A= $49					// these constants are now inside a table
// .const COLLECTOR_SPEED_B	= $2a
// .const COLLECTOR_EDGE_WAIT_B= $39
...
// test points
		...
		// ADD THIS: Calculate correct speed level for starting score
		lda score_bcd
		and #$0f                    // Get hundreds digit
		lsr                         // Divide by 2 (200→1, 400→2, 600→3, 800→4)
		sta drop_speed_level        // Set correct level

		// Also set last_hundred to avoid immediate increment
		lda score_bcd
		and #$0f
		sta last_hundred
