...
kloop:  jsr $ff9f                // waits for any key
        ...
        cmp #$0d                // if return, go and define new keys
        beq new_key
  
        cmp #$20                // if no space, check for the key again
        bne kloop
...
key_l:  lda new_left_key_text,x
        sta VIC_SCREEN_MEMORY + $321,x          // write it to 21st row   
        inx
        cpx #$28
        bne key_l
...
key_r:  lda new_right_key_text,x
        sta VIC_SCREEN_MEMORY + $349,x          // write it to 21st row   
        inx
        cpx #$28
        bne key_r   
...
rk:     jsr $ff9f 
        ...
        ldx #$00                                // clear the new key text
clear:  lda #$20
        sta VIC_SCREEN_MEMORY + $320,x          
        inx
        cpx #$50
        bne clear
